...
public class PpUnificationImpl extends ASTWrapperPsiElement implements PpUnification {

  public PpUnificationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTUnification() {
    return findNotNullChildByType(T_UNIFICATION);
  }
