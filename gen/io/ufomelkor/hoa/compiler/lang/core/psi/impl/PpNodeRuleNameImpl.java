...
public class PpNodeRuleNameImpl extends ASTWrapperPsiElement implements PpNodeRuleName {

  public PpNodeRuleNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PpVisitor visitor) {
    visitor.visitNodeRuleName(this);
  }
