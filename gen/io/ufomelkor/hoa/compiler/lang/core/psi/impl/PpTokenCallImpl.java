...
public class PpTokenCallImpl extends ASTWrapperPsiElement implements PpTokenCall {

  public PpTokenCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PpVisitor visitor) {
    visitor.visitTokenCall(this);
  }
