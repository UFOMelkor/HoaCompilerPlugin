...
package io.ufomelkor.hoa.compiler.plugin.parser;
...
public class PpParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // T_CAPTURING_BEGIN (Choice|Concatenation|Repetition|Simple) T_CAPTURING_END
  ...
  /* ********************************************************** */
  // T_HASH T_NAME
  public static boolean NamedNode(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NamedNode")) return false;
    if (!nextTokenIs(b, T_HASH)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, T_HASH, T_NAME);
    exit_section_(b, m, NAMED_NODE, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // T_HASH? T_RULE_NAME T_COLON Comment? (Choice|Concatenation|Repetition|Simple)
  public static boolean Rule(PsiBuilder b, int l) {
    ...
    r = Rule_0(b, l + 1);
    r = r && consumeTokens(b, 0, T_RULE_NAME, T_COLON);
    r = r && Rule_3(b, l + 1);
    r = r && Rule_4(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  /* ********************************************************** */
  // (Capturing | Skipped | Kept | Named) NamedNode? Comment?
